...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// FOREIGN
    /// </summary>
    public class gwMIT : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwMIT; } }
        public GatewayOptions gatewayOptions
        {
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "Mercadotecnia, Ideas y Tecnología (MIT)",
                        WebUrl: "http://www.centrodepagos.com.mx/cdpweb/inicio.htm",
                        Description: "Foreign (Spanish)",
                        isActive: false,
                        isLive: false,
