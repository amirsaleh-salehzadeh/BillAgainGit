...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// DEAD
    /// </summary>
    public class gwCyberCash : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwCyberCash; } }
        public GatewayOptions gatewayOptions
        {
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "Cyber Cash",
                        WebUrl: "https://www.paypal.com/cybercash",
                        Description: "CyberCash (VeriSign) Acquired by PayPal.",
                        isActive: false,
                        isLive: false,
