...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// RESELLER
    /// </summary>
    public class gwNexCommerce : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwNexCommerce; } }
        public GatewayOptions gatewayOptions
        {
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "Nex Commerce",
                        WebUrl: "http://www.thompsonmerchant.com/",
                        Description: "Reseller Software",
                        isActive: false,
                        isLive: false,
