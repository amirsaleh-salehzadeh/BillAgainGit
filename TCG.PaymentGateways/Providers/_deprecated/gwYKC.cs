...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// FOREIGN
    /// </summary>
    public class gwYKC : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwYKC; } }
        public GatewayOptions gatewayOptions
        {
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "YCK",
                        WebUrl: "http://www.ykc-bos.co.jp",
                        Description: "Foreign (Japan)",
                        isActive: false,
                        isLive: false,
