...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// DEAD
    /// </summary>
    public class gwPayDirect : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwPayDirect; } }
        public GatewayOptions gatewayOptions
        {
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "Pay Direct (Link2Gov)",
                        WebUrl: "http://www.fisglobal.com/products-government-governmentpayments/",
                        Description: "",
                        isActive: false,
                        isLive: false,
