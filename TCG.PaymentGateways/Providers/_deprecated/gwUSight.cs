...
namespace TCG.PaymentGateways.Providers
{
    ...
    /// DEAD
    /// </summary>
    public class gwUSight : IPaymentStrategy
    {
        #region Properties
        public ProviderType GatewayType { get { return ProviderType.gwUSight; } }
            ...
            get
            {
                return new GatewayOptions
                    (
                        DisplayName: "USight",
                        WebUrl: "",
                        Description: "This gateway is no longer in service.",
                        isActive: false,
                        isLive: false,
