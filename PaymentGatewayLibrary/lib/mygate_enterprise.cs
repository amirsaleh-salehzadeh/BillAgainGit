...
namespace TCG.PaymentGatewayLibrary.MyGateGlobalEnterprise
{
    /// <remarks/>
    ...
    public partial class ePayService5x0x0 : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        /// <remarks/>
        public ePayService5x0x0()
        {
            this.Url = "https://dev-enterprise.mygateglobal.com/5x0x0/epayservice.cfc";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginfProcessAndSettle(
                    string GatewayID,
                    string MerchantID,
                    string ApplicationID,
                    string TransactionIndex,
                    ...
                    object asyncState)
        {
            return this.BeginInvoke("fProcessAndSettle", new object[] {
                    GatewayID,
                    MerchantID,
                    ApplicationID,
                    TransactionIndex,
        ...
        /// <remarks/>
        public object[] EndfProcessAndSettle(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((object[])(results[0]));
        }
